        ...
        }
        {
          !$isLoading && ($apiBodyParagraphResponse.length > 2)
            ...
            <section class="relative">
              ...
              <p class="mt-3 block whitespace-pre-line text-xl leading-snug text-black dark:text-white pr-8">{$apiTitleParagraphResponse}</p>
              <p class="mt-3 block whitespace-pre-line text-xl leading-snug text-black dark:text-white pr-7">{$apiBodyParagraphResponse}</p>
            </section>
            : null
        }
