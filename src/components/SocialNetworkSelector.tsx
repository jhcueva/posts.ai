  ...
  return (
    <ul class="">
      <li class="border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
        ...
        <label for="twitter" class="rounded-lg cursor-pointer dark:hover:text-[#03A9F4] dark:border-gray-700 dark:peer-checked:text-[#03A9F4] peer-checked:text-[#03A9F4] hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
          <svg
            class="w-10 h-10"
            fill="currentColor"
            viewBox="0 0 24 24"
