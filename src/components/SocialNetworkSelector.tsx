    ...
    <ul class="">
      <li class="border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
        <div class="flex items-center pl-3">
          <input onChange={() => handleClick("twitter")} id="twitter" type="radio" value="" name="list-radio" class="hidden peer" />
          <label for="twitter" class="rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-blue-500 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
            <svg
              class="w-10 h-10"
              fill="currentColor"
              viewBox="0 0 24 24"
      ...
      <li class=" dark:border-gray-600">
        <div class="flex items-center pl-3">
          <input onChange={() => handleClick("instagram")} id="instagram" type="radio" value="" name="list-radio" class="hidden peer" />
          <label for="instagram" class="rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-blue-500 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
            <svg
              class="w-10 h-10"
              fill="currentColor"
              viewBox="0 0 24 24"
