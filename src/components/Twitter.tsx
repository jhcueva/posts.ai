...
import { isEnglish, apiBodyParagraphResponse } from "./store";
...
function TwitterCard() {
  ...
  return (
    <section class="p-10 flex items-center justify-center">
      <article class="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-800 p-4 rounded-xl border max-w-xl">
        ...
        <p class="text-black dark:text-white block text-xl leading-snug mt-3">{$apiBodyParagraphResponse}</p>
